...
public class AccountService {
	...
	public User findUserThirdLoginByOpenId(String openId ,int loginType){
		return loginType==QQ?userDao.findByQqLogin(openId):userDao.findByWeiboLogin(openId);
	}
	...
	public void dentryptPassword(User user){
		byte[] pw = Encodes.decodeHex(user.getPassword());
